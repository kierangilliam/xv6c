...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 6b 08 00 	movl   $0x86b,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42d:	8a 80 d0 0a 00 00    	mov    0xad0(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 586:	75 09                	jne    591 <printf+0x100>
          s = "(null)";
 588:	c7 45 f4 84 08 00 00 	movl   $0x884,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64f:	a1 ec 0a 00 00       	mov    0xaec,%eax
...
free(void *ap)
{
 ...
 71a:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 71f:	c9                   	leave  
 720:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 76d:	e8 ce fe ff ff       	call   640 <free>
  return freep;
 772:	a1 ec 0a 00 00       	mov    0xaec,%eax
}
 777:	c9                   	leave  
 778:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 789:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 78c:	a1 ec 0a 00 00       	mov    0xaec,%eax
 791:	89 45 f0             	mov    %eax,-0x10(%ebp)
 794:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 798:	75 23                	jne    7bd <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 79a:	c7 45 f0 e4 0a 00 00 	movl   $0xae4,-0x10(%ebp)
 7a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a4:	a3 ec 0a 00 00       	mov    %eax,0xaec
 7a9:	a1 ec 0a 00 00       	mov    0xaec,%eax
 7ae:	a3 e4 0a 00 00       	mov    %eax,0xae4
    base.s.size = 0;
 7b3:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7ba:	00 00 00 
  }
 ...
 810:	a3 ec 0a 00 00       	mov    %eax,0xaec
      return (void*)(p + 1);
 ...
 81b:	eb 38                	jmp    855 <malloc+0xdc>
    ...
    if(p == freep)
 81d:	a1 ec 0a 00 00       	mov    0xaec,%eax
